package com.syntra.paymentservice.config.swagger.authorization;

import com.syntra.paymentservice.config.KeycloakProperties;
import com.syntra.paymentservice.config.swagger.SwaggerConfig;
